...
export async function getAllInfectiousDisease(req, res) {
  try {
...
// Get all diseases in category "Bệnh mãn tính" and need vaccine
export async function getAllChronicDisease(req, res) {
  try {
    const result = await query(`
            SELECT *
            FROM disease
